...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.webBtn = QtWidgets.QPushButton(self.horizontalLayoutWidget)
        self.runBtn.setObjectName("webBtn")
        self.gridLayout.addWidget(self.webBtn, 3, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.webBtn.setText(_translate("MainWindow", "web浏览"))
